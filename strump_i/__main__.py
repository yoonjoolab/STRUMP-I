...
from . import strumpi
from strump_i.functions import parse_energy, parse_quality, parse_sasa, predict_binder, calculate_sasa
...
def main():
    ...
    subparser_modeler.add_argument("--tinker_dir")
    subparser_modeler.add_argument("--foldx")
